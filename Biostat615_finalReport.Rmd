...
Let's create a temporary directory and double check we have a few more dependencies to download and process some data as well as plot our results, 
...
```{r}
clean_alu(paste0(data_dir, "/highest_probability") data_dir)
```

Alternatively, to avoid downloading the raw data and processing it, you can download the processed data directly to run our implementation of the Leiden algorithm on it.
