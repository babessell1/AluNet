...
```{r}
seed <- 1
result <- AluNet::runLeiden(g_list, iterations, gamma, theta, seed)
plotLeiden(result)
```
...
Next we try with some larger more complex toy models to also show that iGraph's
...
Then we run several helper functions to convert each of the data into matrices
